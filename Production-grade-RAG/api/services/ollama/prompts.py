...
class RAGPromptBuilder:
    ...
    def _load_system_prompt(self) -> str:
        ...
        if not prompt_file.exists():
            ...
            return (
                ...
                "Foundry Nuke VFX software. Base your answer STRICTLY on the provided "
    ...
    def create_rag_prompt(self, query: str, chunks: List[Dict[str, Any]]) -> str:
        ...
        prompt += "### Context from Nuke Documentation:\n\n"
        ...
        prompt += f"### Question:\n{query}\n\n"
        prompt += (
            "### Answer:\nProvide a natural, conversational response (not JSON) and cite the relevant documentation sections.\n\n"
        )
