...
from api.exceptions import OllamaConnectionError, OllamaException, OllamaTimeoutError
from api.schemas.ollama import RAGResponse
from api.services.ollama.prompts import RAGPromptBuilder, ResponseParser
...
class OllamaClient:
    ...
    def get_langchain_model(self, model: str, temperature: float = 0.7):
        """Return a LangChain chat model backed by this Ollama service."""
        ...
        try:
            ...
            if response and "response" in response:
                ...
                if use_structured_output:
                    ...
                    sources = list({chunk.get("url") for chunk in chunks if chunk.get("url")})
