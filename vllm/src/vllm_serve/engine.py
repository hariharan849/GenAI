...
async def get_tokenizer():
    ...
    Some vLLM engine implementations may return a coroutine when
    calling `get_tokenizer()`. Handle both coroutine and non-coroutine
    return values to avoid the caller receiving a coroutine object.
    """
    tok = get_engine().get_tokenizer()
