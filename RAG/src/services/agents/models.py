...
class SourceItem(BaseModel):
    ...
    :param url: Link to the documentation page
    :param node_name: Nuke node or section name
    :param relevance_score: Relevance score from retrieval
    """

    url: str = Field(description="Link to documentation page")
    node_name: str = Field(default="", description="Nuke node or section name")
